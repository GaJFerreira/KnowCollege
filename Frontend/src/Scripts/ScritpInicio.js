...
export const irParaCadastro = () => {
    ...
    // Aqui você pode implementar o redirecionamento
    window.location.href = '../telaCadastro/TelaCadastro.html'; // Atualize conforme necessário
  };
  
  export const irParaLogin = () => {
    const navigate = useNavigate();
    navigate('./src/lLogin.jsx');  // Isso redireciona para a página de login sem recarregar a página
  };
